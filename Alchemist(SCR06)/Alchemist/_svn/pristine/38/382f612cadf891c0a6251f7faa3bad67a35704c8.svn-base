...
namespace Alchemist
{
    public class SystemConstants
    {
        ...
        public const int BANK_MAX = 499;	            /* バンク数の限度値 */
        ...
        public const int SERIAL_POLLING_INTERVAL = 10000;           /* ポーリング間隔（ミリ秒） */
        public const int INFOMATION_REDISPLAY_INTERVAL = 30000;     /* 情報ウインドウの再表示間隔（ミリ秒） */

        // 通信の切断理由
        public const int COM_ERROR_NORMAL = 0;                      /* 通信エラーなし */
        public const int COM_ERROR_RETRYERROR = 1;                  /* 通信リトライエラー */
        #endregion /* アドレス */

        #region /* マシンステータスビット */
        public const int BIT_SEEK_ORIGIN = 0x0001;      /* 原点サーチビット */
        public const int BIT_STOP = 0x0002;             /* 停止中ビット */
        public const int BIT_RUN = 0x0004;              /* 運転中ビット */
